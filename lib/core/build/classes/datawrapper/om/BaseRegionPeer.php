...
abstract class BaseRegionPeer
{
    ...
    const BOUNDING_BOX = 'region.bounding_box';

    /** the column name for the outline_topojson field */
    const OUTLINE_TOPOJSON = 'region.outline_topojson';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Aspect', 'Projection', 'Area', 'BoundingBox', 'OutlineTopojson', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'aspect', 'projection', 'area', 'boundingBox', 'outlineTopojson', ),
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID, RegionPeer::TITLE, RegionPeer::ASPECT, RegionPeer::PROJECTION, RegionPeer::AREA, RegionPeer::BOUNDING_BOX, RegionPeer::OUTLINE_TOPOJSON, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'ASPECT', 'PROJECTION', 'AREA', 'BOUNDING_BOX', 'OUTLINE_TOPOJSON', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'aspect', 'projection', 'area', 'bounding_box', 'outline_topojson', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Aspect' => 2, 'Projection' => 3, 'Area' => 4, 'BoundingBox' => 5, 'OutlineTopojson' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'aspect' => 2, 'projection' => 3, 'area' => 4, 'boundingBox' => 5, 'outlineTopojson' => 6, ),
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID => 0, RegionPeer::TITLE => 1, RegionPeer::ASPECT => 2, RegionPeer::PROJECTION => 3, RegionPeer::AREA => 4, RegionPeer::BOUNDING_BOX => 5, RegionPeer::OUTLINE_TOPOJSON => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'ASPECT' => 2, 'PROJECTION' => 3, 'AREA' => 4, 'BOUNDING_BOX' => 5, 'OUTLINE_TOPOJSON' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'aspect' => 2, 'projection' => 3, 'area' => 4, 'bounding_box' => 5, 'outline_topojson' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RegionPeer::TITLE);
            $criteria->addSelectColumn(RegionPeer::ASPECT);
            $criteria->addSelectColumn(RegionPeer::PROJECTION);
            $criteria->addSelectColumn(RegionPeer::AREA);
            $criteria->addSelectColumn(RegionPeer::BOUNDING_BOX);
            $criteria->addSelectColumn(RegionPeer::OUTLINE_TOPOJSON);
        } else {
